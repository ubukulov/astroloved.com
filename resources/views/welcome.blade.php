...
@section('header')
    ...
    <div class="main-header-text text-center">
        ...
        <div class="main-header-buttons">
            ...
            <button type="button" onclick='window.location="{{ route('show.consultation.new') }}"' class="btn btn-violet rounded-pill">Консультация астролога</button>
        </div>
    </div>
@stop
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <div class="opis-consult">
                                ...
                                <div class="knopp">
                                    <a href="{{ route('show.consultation.new') }}" class="btn rounded-pill fiol">Заказать консультацию</a>
            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item">
                <div class="wrap-items">
                  ...
                  <h5>Кайрат Мардушев</h5>
                  <p>Далеко-далеко за словесными горами в стране, гласных и согласных живут рыбные тексты. Которой знаках текст прямо всеми, до его безопасную страна буквоград всемогущая предупреждал, большого на берегу дорогу страну, напоивший букв решила то осталось наш ipsum жаренные языкового первую повстречался рукописи. Языкового буквенных пор что подпоясал своих большого буквоград, взобравшись, рыбными заманивший ipsum.</p>
                </div>
              </div>
              <div class="carousel-item">
                <div class="wrap-items">
